...
class MaterialsTestCase(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.lesson = Lesson.objects.create(
            name="Test Lesson", description="Test Description", owner=self.user
        )
    ...
    def test_update_lesson(self):
        ...
        data = {"name": "Updated Lesson", "description": "Updated Description"}

        response = self.client.put(
            f"/lesson/update/{self.lesson.id}/", data, format="json"
        )
    ...
    def test_subscription(self):
        ...
        )  # Проверяем, что в ответе есть сообщение
