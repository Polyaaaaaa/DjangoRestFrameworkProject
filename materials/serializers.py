...
class CourseSerializers(serializers.ModelSerializer):
    ...
    lesson_quantity = serializers.SerializerMethodField(source='lessons.all.first.lessons', read_only=True)
    ...
    class Meta:
        ...
        validators = [
            ...
            serializers.UniqueTogetherValidator(fields=['name', 'description', 'video_link'], queryset=Course.objects.all())
        ]
